...
|---|---|---|---|---|
| 🧠 | [00 - Factory Brain](./00---factory-brain.md) | 41 | 20 | Master rules, strategy, workspace context, operating model, decisions, quality s |
...
| ⚙️ | [05 - Parallel Build](./05---parallel-build.md) | 7 | 5 | Frontend, backend, mobile, integrations, automation, coding tasks executed in pa |
...
| 🚀 | [07 - Deploy Documentation Handover](./07---deploy-documentation-handover.md) | 8 | 3 | Deployment runbooks, environment setup, release notes, rollback plans, user guid |
| 📚 | [08 - Skill Library](./08---skill-library.md) | 22 | 13 | Reusable skills, app templates, prompt templates, workflow templates — the works |
| 🔬 | [09 - Research Intelligence](./09---research-intelligence.md) | 54 | 35 | Research tasks, GitHub repos, AI updates, benchmarks, competitors, best practice |
