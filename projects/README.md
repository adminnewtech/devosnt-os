...
|---|---|---|---|---|
| 🧠 | [00 - Factory Brain](./00---factory-brain.md) | 112 | 71 | Master rules, strategy, workspace context, operating model, decisions, quality s |
...
| 📚 | [08 - Skill Library](./08---skill-library.md) | 44 | 25 | Reusable skills, app templates, prompt templates, workflow templates — the works |
