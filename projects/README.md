...
|---|---|---|---|---|
| 🧠 | [00 - Factory Brain](./00---factory-brain.md) | 15 | 14 | Master rules, strategy, workspace context, operating model, decisions, quality s |
...
| 🛡️ | [06 - QA Security Performance](./06---qa-security-performance.md) | 2 | 1 | Test plans, bug reports, security reviews, performance tests, permissions valida |
| 🚀 | [07 - Deploy Documentation Handover](./07---deploy-documentation-handover.md) | 3 | 1 | Deployment runbooks, environment setup, release notes, rollback plans, user guid |
