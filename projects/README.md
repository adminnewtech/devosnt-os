...
|---|---|---|---|---|
| 🧠 | [00 - Factory Brain](./00---factory-brain.md) | 131 | 83 | Master rules, strategy, workspace context, operating model, decisions, quality s |
...
| 📚 | [08 - Skill Library](./08---skill-library.md) | 47 | 29 | Reusable skills, app templates, prompt templates, workflow templates — the works |
| 🔬 | [09 - Research Intelligence](./09---research-intelligence.md) | 112 | 88 | Research tasks, GitHub repos, AI updates, benchmarks, competitors, best practice |
