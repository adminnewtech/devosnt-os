...
|---|---|---|---|---|
| 🧠 | [00 - Factory Brain](./00---factory-brain.md) | 100 | 68 | Master rules, strategy, workspace context, operating model, decisions, quality s |
...
| 📚 | [08 - Skill Library](./08---skill-library.md) | 43 | 25 | Reusable skills, app templates, prompt templates, workflow templates — the works |
| 🔬 | [09 - Research Intelligence](./09---research-intelligence.md) | 100 | 78 | Research tasks, GitHub repos, AI updates, benchmarks, competitors, best practice |
