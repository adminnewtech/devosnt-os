...
|---|---|---|---|---|
| 🧠 | [00 - Factory Brain](./00---factory-brain.md) | 25 | 14 | Master rules, strategy, workspace context, operating model, decisions, quality s |
| 💡 | [01 - App Requests](./01---app-requests.md) | 2 | 1 | All new app ideas and system requests start here. Intake → triage → routed to Pr |
...
| 🚀 | [07 - Deploy Documentation Handover](./07---deploy-documentation-handover.md) | 6 | 3 | Deployment runbooks, environment setup, release notes, rollback plans, user guid |
| 📚 | [08 - Skill Library](./08---skill-library.md) | 16 | 8 | Reusable skills, app templates, prompt templates, workflow templates — the works |
| 🔬 | [09 - Research Intelligence](./09---research-intelligence.md) | 31 | 9 | Research tasks, GitHub repos, AI updates, benchmarks, competitors, best practice |
