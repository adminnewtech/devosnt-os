...
|---|---|---|---|---|
| 🧠 | [00 - Factory Brain](./00---factory-brain.md) | 45 | 27 | Master rules, strategy, workspace context, operating model, decisions, quality s |
...
| ⚙️ | [05 - Parallel Build](./05---parallel-build.md) | 7 | 6 | Frontend, backend, mobile, integrations, automation, coding tasks executed in pa |
...
| 📚 | [08 - Skill Library](./08---skill-library.md) | 23 | 13 | Reusable skills, app templates, prompt templates, workflow templates — the works |
| 🔬 | [09 - Research Intelligence](./09---research-intelligence.md) | 58 | 44 | Research tasks, GitHub repos, AI updates, benchmarks, competitors, best practice |
