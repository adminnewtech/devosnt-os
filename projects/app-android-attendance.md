...
| DEV-360 | QA Gate: DEV-349 — BUILD: Implement Supabase Edge Functions (punch, sync, report | `blocked` | none |
| DEV-361 | Emulator QA: DEV-352 — run 7 screens, offline sync test, attach screenshots | `blocked` | medium |

## Recent Done

- DEV-365 — QA Gate 2: DEV-350 — Verify revision (loading states + component library)
- DEV-366 — REVISE: Confirm/add Zod validation on /employees, /offices, /shifts CRUD modals
- DEV-367 — QA Gate 3: DEV-350 — Verify CRUD Zod validation (Gate 3 of 3, forecast ACCEPT)
- DEV-350 — BUILD: Next.js admin web frontend shell (RTL Arabic) — Android Attendance
