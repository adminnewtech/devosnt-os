...
| [dashboard-screen-planner](./dashboard-screen-planner.md) | `ceo`, `ux-architect`, `ui-designer` | Produce the sitemap, screen list, and per-screen spec for a dashboard or admin UI. |
...
| [performance-budget-enforcer](./performance-budget-enforcer.md) | `performance-tester` | Hard Core Web Vitals budget enforced in CI. Fail the PR on regression. |
| [performance-review-checklist](./performance-review-checklist.md) | `quality-gate-manager`, `performance-tester` | 12-point performance gate run before a user-facing feature is allowed to ship. |
...
| [pwa-offline-first](./pwa-offline-first.md) | `frontend-engineer`, `mobile-engineer` | Default PWA setup: installable, offline, push, background sync. |
| [qa-test-plan-generator](./qa-test-plan-generator.md) | `ceo`, `quality-gate-manager`, `qa-engineer` | Produce the QA test plan for a feature or full app. |
| [rate-limiting-design](./rate-limiting-design.md) | `solution-architect`, `api-architect`, `backend-engineer` | Default rate limiting: token bucket per user + per IP + per tenant, Redis-backed. |
| [react-dashboard-builder](./react-dashboard-builder.md) | `ui-designer`, `claude-code-lead-developer`, `frontend-engineer` | Build a responsive role-aware dashboard shell (sidebar + topbar + content). |
| [realestate-system-builder](./realestate-system-builder.md) | `solution-architect` | Build a real estate platform: listings, leads, tours, contracts, commissions. |
| [realtime-collaboration-planner](./realtime-collaboration-planner.md) | `full-stack-engineer` | Default realtime patterns for collaborative apps using Supabase Realtime / Pusher / Livebl |
| [realtime-dashboards-builder](./realtime-dashboards-builder.md) | `frontend-engineer` | Default realtime KPI dashboards with live updates, drilldowns, export. |
| [restaurant-system-builder](./restaurant-system-builder.md) | `solution-architect` | Build a restaurant/QSR system: menu, KDS, tables, orders, online order, delivery dispatch. |
...
| [zoho-integration-planner](./zoho-integration-planner.md) | `integration-architect` | Plan a Zoho CRM / Books / Inventory integration with conflict resolution. |
