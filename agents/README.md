...
| [environment-manager](./environment-manager.md) | `claude-haiku-4-5-20251001` | `local` | 5 | Env vars, secrets, feature flags across local/preview/staging/prod. |
| [frontend-engineer](./frontend-engineer.md) | `claude-sonnet-4-6` | `local` | 11 | Next.js + TS + Tailwind frontend implementation with accessibility + responsive. |
...
| [qa-engineer](./qa-engineer.md) | `claude-sonnet-4-6` | `local` | 5 | Writes + executes QA test plans. Pass/fail every shippable feature. |
...
| [release-manager](./release-manager.md) | `claude-haiku-4-5-20251001` | `local` | 6 | Release notes, customer comms, post-deploy verification. |
...
| [solution-architect](./solution-architect.md) | `claude-sonnet-4-6` | `local` | 25 | Tech stack + ADRs + build graph. Default Next.js + Supabase + Vercel. |
| [sprint-commander](./sprint-commander.md) | `claude-sonnet-4-6` | `local` | 2 | Sprint cadence + parallel WIP enforcement across all squads. |
...
| [ui-designer](./ui-designer.md) | `claude-sonnet-4-6` | `local` | 5 | Design tokens, primitives, composed screens (LTR + RTL). |
| [ux-architect](./ux-architect.md) | `claude-sonnet-4-6` | `local` | 6 | PRD → sitemap → user flows → screen list with states + role visibility. |
| [workspace-operations-manager](./workspace-operations-manager.md) | `claude-haiku-4-5-20251001` | `local` | 4 | Owns workspace settings, agent lifecycle, runtime health, quarterly upgrade. |
