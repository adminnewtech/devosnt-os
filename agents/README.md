...
| [skill-builder](./skill-builder.md) | `claude-sonnet-4-6` | `local` | 3 | Lifts 3x-repeated workflows into reusable skills. |
...
| [ux-architect](./ux-architect.md) | `claude-sonnet-4-6` | `local` | 5 | PRD → sitemap → user flows → screen list with states + role visibility. |
