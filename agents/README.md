...
| [backend-engineer](./backend-engineer.md) | `claude-sonnet-4-6` | `local` | 10 | API endpoints, DB access, jobs, webhooks. Codex runtime. |
...
| [ceo](./ceo.md) | `claude-sonnet-4-6` | `local` | 26 | CEO Orchestrator — founding agent. Routes every issue, enforces the IDEA → DEPLO |
| [claude-code-lead-developer](./claude-code-lead-developer.md) | `claude-sonnet-4-6` | `local` | 9 | Orchestrates Build Squad. Decomposes parents, assigns engineers, unblocks. |
...
| [frontend-engineer](./frontend-engineer.md) | `claude-sonnet-4-6` | `local` | 13 | Next.js + TS + Tailwind frontend implementation with accessibility + responsive. |
| [full-stack-engineer](./full-stack-engineer.md) | `claude-sonnet-4-6` | `local` | 11 | Small end-to-end features (UI + API + migration) in one PR. Opencode runtime. |
...
| [mobile-engineer](./mobile-engineer.md) | `claude-sonnet-4-6` | `local` | 7 | React Native (Expo) mobile apps. Claude runtime (swapped from Openclaw→Codex→Cla |
