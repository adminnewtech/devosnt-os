...
| [database-architect](./database-architect.md) | `claude-sonnet-4-6` | `local` | 9 | RLS-first PostgreSQL schema with indexes, audit, money + timezone hygiene. |
...
| [integration-architect](./integration-architect.md) | `claude-sonnet-4-6` | `local` | 9 | Plans every external integration (payments, Shopify, Zoho, WhatsApp). |
...
| [security-auditor](./security-auditor.md) | `claude-sonnet-4-6` | `local` | 12 | Runs security-review-checklist. Veto on fail. |
...
| [skill-builder](./skill-builder.md) | `claude-sonnet-4-6` | `local` | 5 | Lifts 3x-repeated workflows into reusable skills. |
