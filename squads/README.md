...
|---|---|---|
| [Architecture Squad](./architecture-squad.md) | 5 | Tech stack, database schemas, API contracts, auth, permissions, integrations. Outputs impl |
...
| [Research Intelligence Squad](./research-intelligence-squad.md) | 5 | Researches GitHub, docs, changelogs, competitors, AI tools, and best practices. Keeps the  |
| [Skill Factory Squad](./skill-factory-squad.md) | 5 | Converts repeated successful workflows into reusable skills, templates, and memory. Compou |
